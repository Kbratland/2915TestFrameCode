...
public class RobotContainer {
    ...
    private void configureButtonBindings() {
        ...
        twangButton9
                .whileTrue(new RunCommand(() -> m_RingStoreSubsystem.GastroIntestinalPush(0.75), m_RingStoreSubsystem));

        twangButton2
                .whileTrue(new RunCommand(() -> m_IntakeSubsystem.IntakeSPIIIIIIIIIIIIIIN(0.75), m_IntakeSubsystem));
